...
ActiveRecord::Schema.define(version: 2021_06_29_110748) do
  ...
  create_table "digital_object_links", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "digital_objects", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "folder_items", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "folder_id"
    t.integer "item_id"
    t.string "item_type"
    t.datetime "created_at"
  ...
  create_table "folders", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "holdings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "source_id"
    t.string "lib_siglum"
  ...
  create_table "holdings_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "holdings_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "person_id"
    t.integer "holding_id"
  ...
  create_table "holdings_to_places", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "holding_id"
  ...
  create_table "holdings_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "institutions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.text "alternates", limit: 16777215
  ...
  create_table "institutions_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "institutions_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "institution_id"
    t.integer "person_id"
  ...
  create_table "institutions_to_places", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "institution_id"
  ...
  create_table "institutions_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "publication_id"
    t.integer "institution_id"
  ...
  create_table "institutions_to_standard_terms", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "institutions_users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "institution_id"
  ...
  create_table "institutions_workgroups", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "liturgical_feasts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.integer "lock_version", default: 0, null: false
    t.text "alternate_terms", limit: 16777215
    t.text "sub_topic", limit: 16777215
    t.string "viaf"
    t.string "gnd"
  ...
  create_table "people", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.string "source"
    t.text "alternate_names", limit: 16777215
    t.text "alternate_dates", limit: 16777215
    t.text "comments", limit: 16777215
    t.text "marc_source", limit: 16777215
    t.integer "wf_audit", default: 0
    t.integer "wf_stage", default: 0
  ...
  create_table "people_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "institution_id"
    t.integer "person_id"
  ...
  create_table "people_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "people_to_places", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "person_id"
  ...
  create_table "people_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "person_id"
    t.integer "publication_id"
  ...
  create_table "places", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name", null: false
    t.string "country"
    t.string "district"
    t.text "notes", limit: 16777215
  ...
  create_table "publications", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.text "marc_source", limit: 4294967295
    t.integer "lock_version", default: 0, null: false
  ...
  create_table "publications_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "publication_id"
    t.integer "institution_id"
  ...
  create_table "publications_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "publication_id"
    t.integer "person_id"
  ...
  create_table "publications_to_places", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "publication_id"
  ...
  create_table "publications_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "publications_to_standard_terms", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "standard_term_id"
    t.integer "publication_id"
  ...
  create_table "sources_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "institution_id"
    t.integer "source_id"
  ...
  create_table "sources_to_liturgical_feasts", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "sources_to_people", id: :bigint, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "person_id"
    t.integer "source_id"
    t.string "marc_tag"
  ...
  create_table "sources_to_places", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "source_id"
  ...
  create_table "sources_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "publication_id"
    t.integer "source_id"
  ...
  create_table "sources_to_sources", id: :bigint, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "sources_to_standard_terms", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "standard_term_id"
    t.integer "source_id"
  ...
  create_table "sources_to_standard_titles", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "sources_to_works", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "source_id"
    t.integer "work_id"
  ...
  create_table "standard_terms", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "standard_titles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "users", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.text "notifications", limit: 16777215
  ...
  create_table "users_workgroups", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "workgroup_id"
  ...
  create_table "work_incipits", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "work_id"
    t.string "nr_work"
    t.string "movement"
    t.string "excerpt"
    ...
    t.text "general_note", limit: 16777215
    t.string "key_mode"
    t.string "validity"
    t.string "code"
    t.text "notation", limit: 16777215
    t.text "text_incipit", limit: 16777215
    t.text "public_note", limit: 16777215
  ...
  create_table "workgroups", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "works", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "person_id"
    t.string "title"
    t.string "opus"
    t.text "catalogue", limit: 16777215
    t.integer "wf_audit", default: 0
    t.integer "wf_stage", default: 0
    t.integer "wf_owner", default: 0
    t.datetime "created_at"
  ...
  create_table "works-001", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "person_id"
    t.string "title"
    t.string "opus"
    t.text "catalogue", limit: 16777215
  ...
  create_table "works_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "institution_id"
  ...
  create_table "works_to_liturgical_feasts", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "liturgical_feast_id"
  ...
  create_table "works_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "person_id"
  ...
  create_table "works_to_publications", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "publication_id"
  ...
  create_table "works_to_standard_terms", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "standard_term_id"
  ...
  create_table "works_to_standard_titles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "standard_title_id"
  ...
  create_table "works_to_works", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "work_a_id"
    t.integer "work_b_id"
