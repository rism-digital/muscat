...
ActiveRecord::Schema.define(version: 2021_06_28_081916) do
  ...
  create_table "people_to_places", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "place_id"
    t.integer "person_id"
