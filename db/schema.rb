...
ActiveRecord::Schema.define(version: 2023_02_01_083757) do
  ...
  create_table "active_admin_comments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.string "namespace"
    t.text "body"
  ...
  create_table "digital_object_links", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "digital_objects", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "folder_items", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "folder_id"
    t.integer "item_id"
    t.string "item_type"
    t.datetime "created_at"
  ...
  create_table "folders", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "holdings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "source_id"
    t.string "lib_siglum"
    t.text "marc_source"
    t.integer "lock_version", default: 0, null: false
  ...
  create_table "holdings_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "holdings_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "person_id"
    t.integer "holding_id"
  ...
  create_table "holdings_to_places", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "holding_id"
  ...
  create_table "holdings_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "institutions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "institutions_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "institutions_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "institution_id"
    t.integer "person_id"
  ...
  create_table "institutions_to_places", id: :bigint, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "institution_id"
    t.string "marc_tag"
  ...
  create_table "institutions_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "publication_id"
    t.integer "institution_id"
  ...
  create_table "institutions_to_standard_terms", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "institutions_users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "institution_id"
  ...
  create_table "institutions_workgroups", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "liturgical_feasts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "people", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.string "full_name"
  ...
  create_table "people_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "institution_id"
    t.integer "person_id"
  ...
  create_table "people_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "people_to_places", id: :bigint, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "person_id"
    t.string "marc_tag"
    t.string "relator_code"
  ...
  create_table "people_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "person_id"
    t.integer "publication_id"
  ...
  create_table "places", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.string "name", null: false
    t.string "country"
    t.string "district"
    t.text "notes"
  ...
  create_table "publications", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.string "short_name"
    t.string "author"
    t.string "title"
    t.string "journal"
  ...
  create_table "publications_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "publication_id"
    t.integer "institution_id"
  ...
  create_table "publications_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "publication_id"
    t.integer "person_id"
  ...
  create_table "publications_to_places", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "publication_id"
  ...
  create_table "publications_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "publications_to_standard_terms", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "standard_term_id"
    t.integer "publication_id"
  ...
  create_table "roles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "sources", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "source_id"
  ...
  create_table "sources_to_institutions", id: :bigint, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "institution_id"
    t.integer "source_id"
    t.string "marc_tag"
    t.string "relator_code"
  ...
  create_table "sources_to_liturgical_feasts", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "sources_to_people", id: :bigint, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "person_id"
    t.integer "source_id"
    t.string "marc_tag"
    t.string "relator_code"
  ...
  create_table "sources_to_places", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "place_id"
    t.integer "source_id"
  ...
  create_table "sources_to_publications", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "publication_id"
    t.integer "source_id"
  ...
  create_table "sources_to_sources", id: :bigint, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "sources_to_standard_terms", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "standard_term_id"
    t.integer "source_id"
  ...
  create_table "sources_to_standard_titles", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "sources_to_work_nodes", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "source_id"
  ...
  create_table "sources_to_works", id: :bigint, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "source_id"
    t.integer "work_id"
    t.string "marc_tag"
    t.string "relator_code"
  ...
  create_table "standard_terms", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "standard_titles", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "users_roles", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "role_id"
    t.index ["user_id", "role_id"], name: "index_users_roles_on_user_id_and_role_id"
  end

  create_table "users_workgroups", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "workgroup_id"
  ...
  create_table "versions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
  ...
  create_table "work_incipits", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_id"
    t.string "nr_work"
    t.string "movement"
    t.string "excerpt"
  ...
  create_table "work_nodes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "person_id"
    t.string "title"
    t.string "form"
    t.text "notes"
  ...
  create_table "work_nodes_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_node_id"
    t.integer "institution_id"
  ...
  create_table "work_nodes_to_liturgical_feasts", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_node_id"
    t.integer "liturgical_feast_id"
  ...
  create_table "work_nodes_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_node_id"
    t.integer "person_id"
  ...
  create_table "work_nodes_to_publications", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_node_id"
    t.integer "publication_id"
  ...
  create_table "work_nodes_to_standard_terms", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_node_id"
    t.integer "standard_term_id"
  ...
  create_table "work_nodes_to_standard_titles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_node_id"
    t.integer "standard_title_id"
  ...
  create_table "workgroups", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "works_to_institutions", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "institution_id"
    t.index ["institution_id"], name: "index_works_to_institutions_on_institution_id"
  ...
  create_table "works_to_liturgical_feasts", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "liturgical_feast_id"
    t.index ["liturgical_feast_id"], name: "index_works_to_liturgical_feasts_on_liturgical_feast_id"
  ...
  create_table "works_to_people", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "person_id"
    t.index ["person_id"], name: "index_works_to_people_on_person_id"
  ...
  create_table "works_to_publications", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "publication_id"
    t.index ["publication_id"], name: "index_works_to_publications_on_publication_id"
  ...
  create_table "works_to_standard_terms", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "standard_term_id"
    t.index ["standard_term_id"], name: "index_works_to_standard_terms_on_standard_term_id"
  ...
  create_table "works_to_standard_titles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_id"
    t.integer "standard_title_id"
    t.index ["standard_title_id"], name: "index_works_to_standard_titles_on_standard_title_id"
  ...
  create_table "works_to_works", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci", force: :cascade do |t|
    t.integer "work_a_id"
    t.integer "work_b_id"
