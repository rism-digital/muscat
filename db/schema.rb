...
ActiveRecord::Schema.define(version: 2022_10_11_100327) do
  ...
  create_table "catalogues", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.string "author"
  ...
  create_table "catalogues_catalogues", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "catalogues_to_catalogues", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "catalogue_a_id"
    t.integer "catalogue_b_id"
  ...
  create_table "catalogues_to_institutions", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "catalogues_to_people", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "catalogue_id"
    t.integer "person_id"
  ...
  create_table "catalogues_to_places", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "place_id"
    t.integer "catalogue_id"
  ...
  create_table "catalogues_to_standard_terms", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "crono_jobs", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "holdings_institutions", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "holdings_to_catalogues", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "catalogue_id"
    t.integer "holding_id"
  ...
  create_table "institutions_institutions", id: false, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "institutions_to_catalogues", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "catalogue_id"
    t.integer "institution_id"
  ...
  create_table "institutions_to_places", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "place_id"
    t.integer "institution_id"
  ...
  create_table "people_to_catalogues", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "person_id"
    t.integer "catalogue_id"
  ...
  create_table "sources_to_catalogues", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "catalogue_id"
    t.integer "source_id"
  ...
  create_table "sources_to_works", id: false, charset: "utf8mb3", force: :cascade do |t|
    t.integer "source_id"
    t.integer "work_id"
  ...
  create_table "works_to_catalogues", charset: "utf8mb3", force: :cascade do |t|
    t.integer "work_id"
    t.integer "catalogue_id"
