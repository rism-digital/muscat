class DropDoTables < ActiveRecord::Migration[4.2]
  def change
    remove_foreign_key :do_div_files, column: :do_file_id
    remove_foreign_key :do_div_files, column: :do_div_id
    
    remove_foreign_key :do_divs, column: :do_item_id
    
    remove_foreign_key :do_file_groups, column: :do_item_id
    
    remove_foreign_key :do_files, column: :do_file_group_id
    remove_foreign_key :do_files, column: :do_image_id
