...
gem 'sunspot_rails', "~> 2.5"#, git: 'https://github.com/rism-ch/sunspot', branch: "java9-stack"
gem 'sunspot_solr', "~> 2.5"#, git: 'https://github.com/rism-ch/sunspot', branch: "java9-stack"
gem 'awesome_print'
