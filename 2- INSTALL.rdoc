...
Get the sources if necessary (https://github.com/rism-ch/muscat):

	git clone https://github.com/rism-ch/muscat.git
...
Install the base css:
	...
	cp muscat-custom-sample.scss muscat-custom.scss
	
Edit muscat-custom.scss to enable at least one color.

Se up databases access:

	mysql
	> CREATE DATABASE rism_ch_development CHARACTER SET utf8 COLLATE utf8_general_ci;
