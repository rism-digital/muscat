...
As above, copy the configuration and jar file:
  ...
  cp -R $MUSCAT_HOME/solr-configuration/muscat /usr/local/var/lib/solr/muscat
  cd /usr/local/Cellar/solr/8.11.1/contrib
  mkdir themax
  $MUSCAT_HOME/solr-configuration/jar-8.8-mac/ThemaxQuery-1.0-SNAPSHOT.jar /usr/local/Cellar/solr/8.11.1/contrib/themax
