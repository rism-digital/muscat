...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field '999a_filter_sm', :label => :filter_canon_type, :limit => 10
    config.add_facet_field '999e_filter_sm', :label => :filter_interval, :limit => 10
    config.add_facet_field '999g_filter_sm', :label => :filter_temporal_offset, :limit => 10
    config.add_facet_field '999h_filter_sm', :label => :filter_offset_units, :limit => 10
