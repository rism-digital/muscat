...
class StandardTitle < ApplicationRecord
  ...
  has_many :work_node_standard_title_relations, class_name: "WorkNodeStandardTitleRelation"
  has_many :referring_work_nodes, through: :work_node_standard_title_relations, source: :work_node
