...
class Library < ActiveRecord::Base
  ...
  composed_of :marc, :class_name => "MarcLibrary", :mapping => %w(marc_source)
  ...
  def scaffold_marc
    ...
    new_marc = MarcLibrary.new(File.read("#{Rails.root}/config/marc/#{RISM::BASE}/library/default.marc"))
    new_marc.load_source true
    
    new_100 = MarcNode.new("library", "110", "", "1#")
    new_100.add_at(MarcNode.new("library", "a", self.full_name, nil), 0)
