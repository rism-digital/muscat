...
module ActiveAdmin::ViewsHelper
  ...
  def active_admin_submit_bar( context )
    context.div class: :buttons do
     context.a href: "javascript:marc_editor_send_form('marc_editor_panel','marc_editor_panel', 0, marc_editor_get_model())", class: :marc_save_btn do  context.text_node "Save #{self.resource_class.to_s}" end 
