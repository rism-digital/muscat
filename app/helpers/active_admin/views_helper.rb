  ...
  def active_admin_user_wf( context, item )   
    context.panel (I18n.t :filter_wf) do
      context.attributes_table_for item  do
        ...
        context.row (I18n.t 'helpers.label.folder.work_catalogue_status') { |r| I18n.t("work_catalogue_labels." + r.work_catalogue) } if ( item.work_catalogue && item.is_a?(Publication) && can?(:edit, Work) )
